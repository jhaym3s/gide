...
class WalletBalanceCard extends StatelessWidget {
  const WalletBalanceCard({super.key, required this.viewAmount});
        ...
        children: [
          Text("Available Balance",
              ...
              style: Theme.of(context).textTheme.bodyLarge!.copyWith(
                  fontSize: 12.sp, fontWeight: FontWeight.w400, color: kGrey)),
          SpaceY(4.dy),
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
          ...
          GestureDetector(
            onTap: () {
              moveFromBottomNavBarScreen(
                  context: context, targetScreen: const FundAccountScreen());
            },
            child: Container(
              height: 32.dy,
              width: 114.dx,
