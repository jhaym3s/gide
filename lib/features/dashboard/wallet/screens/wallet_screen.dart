    ...
    return  Scaffold(
      body: SafeArea(
        child: Column(
          ...
          children: [
         TopWalletBar(tabController: _tabController,),
...
class TopWalletBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Container(
        color: kWhite,
        height: 143.dy, width: kScreenWidth(context),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            SpaceY(32.dy),
            ...
            SpaceY(16.dy),
              Padding(
           padding:  EdgeInsets.symmetric(horizontal: 20.dx),
            child: CustomTwoTabBar(tabController: _tabController, label1: "Cash Balance",label2: "Reward Balance",),
          ),
          SpaceY(29.dy),
          Divider(color: kGrey,height: 1.dy,),
          ],
        ),
      ),
    );
