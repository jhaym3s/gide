    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
           SpaceY(64.dy),
           NormalTextFormField(hintText: "xxxx xxxx xxxx xxxx", labelText: "Card Number", controller: cardNumberController, validator: (String? value){
            ...
            children: [
               Expanded(
                 child: NormalTextFormField(
                  width: 170,
                  hintText: "MM/YY", labelText: "Expiry Date", controller: cardNumberController, validator: (String? value){
                            if (value == null || value.isEmpty) {
                            return 'Please enter card number';
                          }
                          return null;
               ...
               Expanded(
                 child: NormalTextFormField(
                  width: 170,
                  hintText: "XXX", labelText: "CVV", controller: cardNumberController, validator: (String? value){
                            if (value == null || value.isEmpty) {
                            return 'Please enter card number';
                          }
                          return null;
           ...
           Row(
             children: [
               Checkbox.adaptive(value: saveCard, onChanged: (value){
                  setState(() {
                    saveCard = !saveCard;
                  });
               }),
